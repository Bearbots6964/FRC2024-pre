...
public class SwerveModule {
  ...
  /**
   * Enable {@link SwerveModuleState2} optimizations so the angle is reversed and
   * speed is reversed to ensure the module
  ...
  public double getRelativePosition() {
    var i = angleMotor.getPosition(); // returns a number from (-inf, inf)
