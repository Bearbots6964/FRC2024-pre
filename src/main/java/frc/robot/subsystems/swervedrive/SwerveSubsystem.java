...
public class SwerveSubsystem extends SubsystemBase {
  ...
  /**
   * Use the Limelight's readings of AprilTags in view to add a vision reading.
   * Uses the MegaTag and botpose functionality of the Limelight to get the robot
   * transform in field-space.
   */

  public void getLimelightVisionReading() {
    // Get the botpose from limelightlib
    Pose2d botPose = LimelightHelpers.getBotPose2d("limelight");
    // Get the latency from the limelight
    double latency = LimelightHelpers.getLatency_Capture("limelight")
        + LimelightHelpers.getLatency_Pipeline("limelight");

    swerveDrive.addVisionMeasurement(botPose, Timer.getFPGATimestamp() - latency, true, 4);
  }
